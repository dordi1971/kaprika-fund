    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: "maxBlueSupply", type: "uint32" },
...
export const KaprikaProjectAbi = [
  ...
  { type: "function", name: "maxBlueSupply", stateMutability: "view", inputs: [], outputs: [{ type: "uint32" }] },
  ...
  { type: "function", name: "blueMinted", stateMutability: "view", inputs: [], outputs: [{ type: "uint32" }] },
  { type: "function", name: "nextTrancheIndex", stateMutability: "view", inputs: [], outputs: [{ type: "uint8" }] },
  { type: "function", name: "trancheCount", stateMutability: "view", inputs: [], outputs: [{ type: "uint8" }] },
